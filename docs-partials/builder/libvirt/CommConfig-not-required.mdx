<!-- Code generated from the comments of the CommConfig struct in builder/libvirt/comm_config.go; DO NOT EDIT MANUALLY -->
...
<!-- End of code generated from the comments of the CommConfig struct in builder/libvirt/comm_config.go; -->
